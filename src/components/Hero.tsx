...
export default function Hero() {
  const gradientStyle: string = "h-[508px] md:h-[640px] xl:h-[632px] w-full max-w-[375px] md:max-w-[689px] xl:max-w-[1110px] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-transparent from-[45%] to-n-grey-v-dark to-[75%] md:to-[80%] xl:to-[90%]";
  ...
  return (
    <div className="flex justify-center bg-n-grey-v-dark h-[508px] md:h-[640px] xl:h-[632px] mb-[40px] md:mb-[96px] xl:mb-[120px]">
      ...
      <div className={`${gradientStyle} absolute z-10 top-[92px] md:top-[89px] xl:top-[97px]`}/>
      <div className="relative flex text-center xl:text-start w-full max-w-[375px] md:max-w-[689px] xl:max-w-[1110px]">
        <div className="relative z-30 flex flex-col font-manrope xl:w-[1110px] text-n-white px-6 ">
          ...
          <Link to="/headphones/xx99-mark-two-headphones" onClick={() => window.scrollTo(0, 0)} className="self-center xl:self-start text-nowrap w-min mb-[112px] md:mb-[167px]">
